...
@Named("SendMailPaiementSmartPhone")
@Component
public class SendMailPaiementSmartPhone implements JavaDelegate {
    @Autowired
    ...
    public void execute(DelegateExecution execution) throws Exception {
        try {
            ...
            String msg = String.format(
                    "<html>" +
                            "<body>" +
                            "<h2>Notification de paiement réussi via SmartPhone</h2>" +
                            "<p>Bonjour %s %s,</p>" +
                            "<p>Nous vous informons que votre paiement via SmartPhone a été effectué avec succès.</p>" +
